...
public class OllamaService
{
    ...
    public async Task<string> GetNutritionResponseAsync(string sexo, int edad, double peso, double altura, string preferencias, string mensaje, string objetivo)
    {
        var prompt = $"""
